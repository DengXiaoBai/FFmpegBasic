...
//
//  Created by DengXiaoBai on 2018/4/27.
...
static int decode_thread(void *arg) {
    ...
    for(;;) {
        ...
        if (packet->stream_index == is->audio_index) {
...
int play_sound_only(char* sound_url){
    ...
    av_strlcpy(is->filename, sound_url, sizeof(is->filename));
