...
int main(int argc, const char * argv[]) {
    ...
    char *inUrl = "/Users/stringstech-macmini1/Desktop/AV_Study/FFmpeg_Leixiaohua-master/视音频数据处理入门：PCM音频采样数据处理/resources/drum.pcm";
    //输出资源路径，此地址要更换为自己的电脑路径
    char *outUrl = "/Users/stringstech-macmini1/Desktop/AV_Study/FFmpeg_Leixiaohua-master/视音频数据处理入门：PCM音频采样数据处理/5.从PCM16LE单声道音频采样数据中截取一部分数据/results/";
